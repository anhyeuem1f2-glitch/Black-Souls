...
class Game_Battler < Game_BattlerBase
  ...
  def state_regenerate_message_set(id)
    case id
    when 0; return  "%s đã hồi phục %s Máu!"
    when 1; return  "%s nhận %s sát thương!"
    when 2; return  "%s đã hồi phục %s Mana!"
    when 3; return  "%s mất %s Mana!"
    when 4; return  "%s đã hồi phục %s Nộ!"
    when 5; return  "%s mất %s Nộ!"
    end
  end
end
#==============================================================================
