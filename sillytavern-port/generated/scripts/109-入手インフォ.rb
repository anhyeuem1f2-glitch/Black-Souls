...
module CUSTOM_GET_WINDOW
  DISPLAY_FLAG = 22
  GOLD_TEXT_ADD      = "Nhận Được Linh Hồn!"      #お金を入手した際の表示テキスト
  GOLD_TEXT_REMOVE   = "Mất Linh Hồn…"      #お金を消失した際の表示テキスト
  ITEM_TEXT_ADD      = "Nhận Được Vật Phẩm！"  #アイテムを入手した際の表示テキスト
  ITEM_TEXT_REMOVE   = "Mất Vật Phẩm…"  #アイテムを消失した際の表示テキスト
  WEAPON_TEXT_ADD    = "Nhận Được Vũ Khí!"      #武器を入手した際の表示テキスト
  WEAPON_TEXT_REMOVE = "Mất Vũ Khí…"      #武器を消失した際の表示テキスト
  ARMOR_TEXT_ADD     = "Nhận Được Nhẫn!"      #防具を入手した際の表示テキスト
  ARMOR_TEXT_REMOVE  = "Mất Nhẫn…"      #防具を消失した際の表示テキスト
  SKILL_TEXT_ADD     = "Học Được Kỹ Năng!"    #スキルを習得した際の表示テキスト
  SKILL_TEXT_REMOVE  = "Đã Quên Kỹ Năng…"    #スキルを忘れた際の表示テキスト
  EXP_TEXT_ADD       = "Nhận Được Kinh Nghiệm!"       #EXPを入手した際の表示テキスト
  EXP_TEXT_REMOVE    = "Mất Kinh Nghiệm…"       #EXPを消失した際の表示テキスト
