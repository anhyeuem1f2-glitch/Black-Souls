...
1. `https://cdn.jsdelivr.net/gh/anhyeuem1f2-glitch/Black-Souls@streaming-v0.4.1/sillytavern-port/runtime/`
2. `https://testingcf.jsdelivr.net/gh/anhyeuem1f2-glitch/Black-Souls@streaming-v0.4.1/sillytavern-port/runtime/`
3. `https://raw.githubusercontent.com/anhyeuem1f2-glitch/Black-Souls/streaming-v0.4.1/sillytavern-port/runtime/` (last-resort diagnostics; strict browser MIME checks may reject it)
