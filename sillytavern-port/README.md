...
- 640×480 Canvas host, normalized data loader, initial collision logic, keyboard input, a partial event interpreter, transfers, messages, switches/variables/self-switches, fades, and IndexedDB slot persistence.
...
This is not yet a complete or fidelity-qualified port. In particular, VX Ace autotile composition, the RTP dependency, most event commands, battle, and the 57 custom scripts remain incomplete.
