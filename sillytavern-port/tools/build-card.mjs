...
const card = {
  ...
  data: {
    ...
    first_mes: '',
    mes_example: '',
    creator_notes: 'Requires TavernHelper / JS-Slash-Runner 4.8.19 or compatible. Re-import this v0.3.1 card and enable its character script when SillyTavern asks. It auto-mounts directly into the original BLACK SOULS title scene; there is no normal launcher and no AI call. Runtime is pinned to tag name-confirm-v0.3.1 with jsDelivr/testingcf/GitHub Raw module fallbacks. Name Input command 303 resumes the same event interpreter, and missing optional visual assets cannot terminate opening-event logic. Esc is VX Ace Cancel/Menu and never closes the host. Use the explicit Exit to SillyTavern control to leave; a persistent Resume BLACK SOULS control remains.',
    system_prompt: '',
    post_history_instructions: '',
    alternate_greetings: [],
    tags: ['game', 'BLACK SOULS', 'no-llm-gameplay', 'TavernHelper'],
    creator: 'anhyeuem1f2-glitch / Codex port tooling',
    character_version: '0.3.1',
    extensions: {
      talkativeness: '0.0',
      favorite: false,
      tavern_helper: {
