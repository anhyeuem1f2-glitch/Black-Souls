...
The acceptance regression builds real troop 1 (`Ám Hồn*3`), loads enemy battler `3`, selects original skill 157 over skill 1 by rating, advances AP, executes damage, reaches victory, applies gold/EXP/drop logic, and preserves party state.
